...
desc = [
    ...
    [
        "ngsap",
        "Number of Ground Adjustable Parameters",
        2,
        int,
        {"condition": "f.aptyp == 'G'"},
    ],
    [
        ...
        [
            "gsapid",
            "Ground-space Adjustable Parameter ID",
            4,
            str,
            {"condition": "f.aptyp == 'G'"},
        ],
    ...
    [
        [
            "loop",
            "0 if f.apbase == 'N' else int(f.npar*f.nisap) if f.aptyp == 'I' else int(f.npar*f.ngsap)",
        ],
        [
            "ael",
            "Matrix A Element",
            21,
            float,
            {"frmt": _nsfx_format, "condition": "f.apbase == 'Y'"},
        ],
    ],
    [
        ["loop", "f.npar"],
