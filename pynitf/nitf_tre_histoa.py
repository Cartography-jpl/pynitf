...
desc = [
    ...
    [
        ...
        [["loop", "f.nipcom[i1]"], ["ipcom", "Image Processing Comment", 80, str]],
        ...
        [
            "zoomrow",
            "Mag in Line (row) Direction",
            7,
            float,
            {"condition": "f.asym_flag[i1] == '1'"},
        ],
        [
            "zoomcol",
            "Mag in Element (column) Direction",
            7,
            float,
            {"condition": "f.asym_flag[i1] == '1'"},
        ],
        ["proj_flag", "Image Projection", 1, int],
        ["sharp_flag", "Sharpening", 1, int],
        [
            "sharpfam",
            "Sharpening Family Number",
            2,
            int,
            {"condition": "f.sharp_flag[i1] == 1"},
        ],
        [
            "sharpmem",
            "Sharpening Member Number",
            2,
            int,
            {"condition": "f.sharp_flag[i1] == 1"},
        ],
        ...
        [
            "mag_level",
            "Level of Relative Magnification",
            7,
            float,
            {"condition": "f.mag_flag[i1] == 1"},
        ],
