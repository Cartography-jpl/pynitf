...
desc = [
    ...
    [
        "ggrfep",
        "Ground-to-image Grid Row Fitting Error",
        21,
        float,
        {"frmt": _ggrfep_format, "optional": True},
    ],
    [
        "ggcfep",
        "Ground-to-image Grid Column Fitting Error",
        21,
        float,
        {"frmt": _ggrfep_format, "optional": True},
    ],
    ...
    [
        "xipln1",
        "X Value of Initial Point in Plane 1",
        21,
        float,
        {"frmt": _ggrfep_format},
    ],
    [
        "yipln1",
        "Y Value of Initial Point in Plane 1",
        21,
        float,
        {"frmt": _ggrfep_format},
    ],
    ...
    [
        ...
        [
            ...
            [
                "rcoord",
                "Grid Point's Row Coordinate",
                "f.tnumrd",
                None,
                {"field_value_class": RCoord},
            ],
            [
                "ccoord",
                "Grid Point's Row Coordinate",
