...
desc = [["num_bands", "Number of Bands", 4, int, {'frmt' : "%04d"}],
        ...
        [["loop", "f.num_illum_sets"],
         ...
         [["loop", "f.num_bands"],
          ...
          ["sun_illum", "Solar Illumination", 16, float, {'frmt' : "%016.10lf", 'condition' : "f.existence_mask & 0x1000"}],
          ["moon_illum_method", "Lunar Illumination Estimation Method", 1, str, {'condition' : "f.existence_mask & 0x800"}],
          ["moon_illum", "Lunar Illumination", 16, float, {'frmt' : "%016.10lf", 'condition' : "f.existence_mask & 0x800"}],
          ["tot_sunmoon_illum", "Total Illumination from Sun and Moon", 16, float, {'frmt' : "%016.10lf", 'condition' : "f.existence_mask & 0x400"}],
          [["loop", "f.num_others if(f.existence_mask & 0x200) else 0"],
           ...
           ["other_illum", "Other Natural Light Source Illumination", 16, float, {'frmt' : "%016.10lf"}]],
          ["art_illum_method", "Artificial Illumination Estimation Method", 1, str, {'condition' : "f.existence_mask & 0x100"}],
          ["art_illum_min", "Minimum Artificial Illumination", 16, float, {'frmt' : "%016.10lf", 'condition' : "f.existence_mask & 0x100"}]],
          ["art_illum_max", "Maximum Artificial Illumination", 16, float, {'frmt' : "%016.10lf", 'condition' : "f.existence_mask & 0x100"}]]
]
