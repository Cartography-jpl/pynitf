...
hlp = '''This is the RSMDCA TRE, blah. 
...
desc = [["iid", "Image Identifier", 80, str, {'optional':True}],
        ...
        ["nimge", "Number of Images", 3, int],
        ["npart", "Total number of Parameters", 5, int],
        [["loop", "f.nimge"],
         ["iidi", "Image Identifier", 80, str],
         ["npari", "Number of Parameters", 2, int],
        ],
        ...
        [["loop", "(f.npart+1) * (f.npart) // 2"],
        ["dercov", "Direct Error Covariance Element", 21, float,
         {'frmt' : _xuol_format}],
        ],
]
...
tre_tag_to_cls.add_cls(TreRSMDCA)    
