...
desc =[['sensor_type', 'Sensor Type', 1, str],
        ...
        [["loop", "f.num_sets_fa_data if(f.sensor_type=='F' and f.field_angle_type==0) else 0"],
         ...
         [["loop", "f.num_fa_blocks_line[i1] if(f.sensor_type=='F' and f.field_angle_type==0) else 0"],
          [["loop", "f.num_fa_blocks_samp[i1] if(f.sensor_type=='F' and f.field_angle_type==0) else 0"],
           ["fa_x1", "X-coordinate of the first of the four alignment coordinated for block jk of the nth frame field angle set", 11, float, {'frmt' : "%+011.7lf"}],
           ["fa_y1", "Y-coordinate of the first of the four alignment coordinated for block jk of the nth frame field angle set", 11, float, {'frmt' : "%+011.7lf"}],
           ["fa_x2", "X-coordinate of the second of the four alignment coordinated for block jk of the nth frame field angle set", 11, float, {'frmt' : "%+011.7lf"}],
           ["fa_y2", "Y-coordinate of the second of the four alignment coordinated for block jk of the nth frame field angle set", 11, float, {'frmt' : "%+011.7lf"}],
           ["fa_x3", "X-coordinate of the third of the four alignment coordinated for block jk of the nth frame field angle set", 11, float, {'frmt' : "%+011.7lf"}],
           ["fa_y3", "Y-coordinate of the third of the four alignment coordinated for block jk of the nth frame field angle set", 11, float, {'frmt' : "%+011.7lf"}],
           ["fa_x4", "X-coordinate of the fourth of the four alignment coordinated for block jk of the nth frame field angle set", 11, float, {'frmt' : "%+011.7lf"}],
           ["fa_y4", "Y-coordinate of the fourth of the four alignment coordinated for block jk of the nth frame field angle set", 11, float, {'frmt' : "%+011.7lf"}],
          ],
         ],
        ],
        ...
        [["loop", "f.num_fp_arrays_line if(f.sensor_type=='F' and f.field_angle_type==1) else 0"],
         [["loop", "f.num_fp_arrays_samp if(f.sensor_type=='F' and f.field_angle_type==1) else 0"],
          ["ls_fid_trans_t0", "Image to Fidicual Transform Parameter t0", 21, float, {"frmt" : "%+21.14E"}],
          ["ls_fid_trans_t1", "Image to Fidicual Transform Parameter t1", 21, float, {"frmt" : "%+21.14E"}],
          ["ls_fid_trans_t2", "Image to Fidicual Transform Parameter t2", 21, float, {"frmt" : "%+21.14E"}],
          ["ls_fid_trans_t3", "Image to Fidicual Transform Parameter t3", 21, float, {"frmt" : "%+21.14E"}],
          ["ls_fid_trans_t4", "Image to Fidicual Transform Parameter t4", 21, float, {"frmt" : "%+21.14E"}],
          ["ls_fid_trans_t5", "Image to Fidicual Transform Parameter t5", 21, float, {"frmt" : "%+21.14E"}],
          ["ls_fid_trans_t6", "Image to Fidicual Transform Parameter t6", 21, float, {"frmt" : "%+21.14E"}],
          ["ls_fid_trans_t7", "Image to Fidicual Transform Parameter t7", 21, float, {"frmt" : "%+21.14E"}],
          ],
         ],
