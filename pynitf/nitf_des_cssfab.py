...
desc2 =["CSSFAB",
        ...
        [["loop", "f.num_fp_arrays_line", {"condition" : "f.sensor_type=='F' and f.field_angle_type==1"}],
         [["loop", "f.num_fp_arrays_samp"],
        ...
        [["loop", "f.num_sets_fa_data", {"condition" : "f.sensor_type=='F' and f.field_angle_type==1"}],
        ...
        ["telescope_options_flag", "Flag Variable Indicating if Additional IO Parameters Set Present Due to Telescope Optics Corrections", 1, int, {"condition" : "f.sensor_type=='F'"}],
        ["num_tele_sets_fa_data", "Number of Sets of Telescope Optics Field Angle Data", 1, int, {"condition" : "f.sensor_type=='F' and f.telescope_options_flag == 1"}],
        ["n_frames", "Total Number of Frames in Sequence", 4, None,
         {'field_value_class' : IntFieldData, 'size_not_updated' : True,
          "condition" : "f.sensor_type=='F' and f.telescope_options_flag == 1"}],
        [["loop", "f.n_frames", {"condition" : "f.sensor_type=='F' and f.telescope_options_flag == 1"}],
        ...
        [["loop", "f.num_tele_sets_fa_data", {"condition" : "f.sensor_type=='F' and f.telescope_options_flag == 1"}],
