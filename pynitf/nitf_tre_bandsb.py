...
desc = ["BANDSB",
        ...
        ["cube_scale_factor", "Cube Scale Factor", 4, None, {'field_value_class' : FieldData, 'size_not_updated' : True}],
        ["cube_additive_factor", "Cube Additive Factor", 4, None, {'field_value_class' : FieldData, 'size_not_updated' : True}],
        ...
        ["atmospheric_adjustment_altitude", "Adjustment altitude above WGS84 Ellipsoid", 4, None,
         {'field_value_class' : FieldData, 'size_not_updated' : True, 'condition': "f.existence_mask & 0x80000000"}],
        ...
        [
            ...
            ["scale_factor", "Individual Scale Factor", 4, None,
             {'field_value_class' : FieldData, 'size_not_updated' : True, 'condition' : "f.existence_mask & 0x00040000"}],
        ...
        [["loop", "f.num_aux_b", {'condition': "f.existence_mask & 0x00000001"}],
         ...
         [["loop", "f.count", {'condition': "f.existence_mask & 0x00000001"}],
          ...
          ["apr_band", "Auxiliary Parameter Real Value", 4, None, {'field_value_class': FieldData, 'size_not_updated' : True,'condition': "f.bapf[i1] == \"R\""}],
        ...
        [["loop", "f.num_aux_c"],
         ...
         ["apr_cube", "Auxiliary Parameter Real Value", 4, None,
          {'field_value_class': FieldData, 'size_not_updated' : True, 'condition': "f.capf[i1] == 'R'"}],
