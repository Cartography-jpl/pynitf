...
desc = [
    ...
    [
        ...
        4,
        None,
        {"field_value_class": FloatFieldData, "size_not_updated": True},
    ],
    [
        "cube_additive_factor",
        "Cube Additive Factor",
        4,
        None,
        {"field_value_class": FloatFieldData, "size_not_updated": True},
    ],
    [
        ...
        7,
        str,
    ],  # This field is really weird. The value is 000.001 to 9999.99
    ...
    [
        "spt_resp_col_nom",
        "Spatial Response Function (Cols)",
        7,
        str,
    ],  # Same weirdness as row_gsd
    ...
    [
        ...
        "Adjustment altitude above WGS84 Ellipsoid",
        4,
        None,
        {
    ...
    [
        ...
        7,
        float,
        {"condition": "f.existence_mask & 0x40000000", "frmt": "%07.2f"},
    ],
    [
        "data_fld_2",
        "Field reserved for future use",
        ...
        None,
        {
            ...
            "size_not_updated": True,
            "condition": "f.existence_mask & 0x20000000",
        },
    ],
    [
        "wave_length_unit",
        ...
        1,
        str,
        {"condition": "f.existence_mask & 0x01F80000"},
    ],
    [
        ["loop", "f.count"],
        [
            ...
            50,
            str,
            {"condition": "f.existence_mask & 0x10000000"},
        ],
        [
            "bad_band",
            "Bad Band Flag",
            1,
            int,
            {"condition": "f.existence_mask & 0x08000000"},
        ],
        [
            "niirs",
            "NIIRS Value",
            3,
            float,
            {"condition": "f.existence_mask & 0x04000000"},
        ],
        [
            "focal_len",
            "Band n Focal length",
            5,
            int,
            {"condition": "f.existence_mask & 0x02000000"},
        ],
        [
            "cwave",
            "Band n Center Response Wavelength",
            7,
            float,
            {"condition": "f.existence_mask & 0x01000000"},
        ],
        [
            "fwhm",
            "Band n Width",
            7,
            float,
            {"condition": "f.existence_mask & 0x00800000"},
        ],
        [
            "fwhm_unc",
            "Band n Width Uncertainty",
            7,
            float,
            {"condition": "f.existence_mask & 0x00400000"},
        ],
        [
            "nom_wave",
            "Band n Nominal Wavelength",
            7,
            float,
            {"condition": "f.existence_mask & 0x00200000"},
        ],
        [
            "nom_wave_unc",
            "Band n Nominal Wavelength Uncertainty",
            7,
            float,
        ...
        [
            "lbound",
            "Band n Lower Wavelength Bound",
            7,
            float,
            {"condition": "f.existence_mask & 0x00080000"},
        ],
        [
            "ubound",
            "Band n Upper Wavelength Bound",
            7,
            float,
            {"condition": "f.existence_mask & 0x00080000"},
        ],
        [
            ...
            None,
            {
                "field_value_class": FloatFieldData,
                "size_not_updated": True,
                "condition": "f.existence_mask & 0x00040000",
            },
        ],
        [
            "additive_factor",
            "Individual Additive Factor",
            4,
            None,
            {
                "field_value_class": FloatFieldData,
        ...
        [
            ...
            16,
            str,
            {"condition": "f.existence_mask & 0x00020000"},
        ],
        [
            "int_time",
            "Integration Time",
            6,
            int,
            {"condition": "f.existence_mask & 0x00010000"},
        ],
        [
            "caldrk",
            "Band n Calibration (Dark)",
            6,
            float,
        ...
        [
            "row_gsd",
            "Band n Spatial Response Interval (Row)",
            7,
            float,
        ...
        [
            "col_gsd",
            "Band n Spatial Response Interval (Col)",
            7,
            float,
            {"condition": "f.existence_mask & 0x00004000"},
        ],
        [
            "col_gsd_unc",
            "Band n Spatial Response Interval Uncertainty (Col)",
            7,
            float,
            {"condition": "f.existence_mask & 0x00002000"},
        ],
        ...
        [
            "bknoise",
            "Band n Background Noise",
            5,
            float,
            {"condition": "f.existence_mask & 0x00001000"},
        ],
        [
            "scnnoise",
            "Band n Scene Noise",
        ...
        [
            "spt_resp_function_row",
            "Band n Spatial Response Function (Row)",
            7,
            float,
        ...
        [
            "spt_resp_unc_row",
            "Band n Spatial Response Function Uncertainty (Row)",
            7,
            float,
        ...
        [
            "spt_resp_unit_row",
            "Unit of Spatial Response (Row)",
            1,
            str,
            {"condition": "f.existence_mask & 0x00000800"},
        ],
        [
            "spt_resp_function_col",
            "Band n Spatial Response Function (Col)",
            7,
            float,
            {"condition": "f.existence_mask & 0x00000800"},
        ],
        [
            "spt_resp_unc_col",
            "Band n Spatial Response Function Uncertainty (Col)",
            7,
            float,
            {"condition": "f.existence_mask & 0x00000400"},
        ],
        ...
        [
            ...
            None,
            {
                "field_value_class": BytesFieldData,
                "size_not_updated": True,
                "condition": "f.existence_mask & 0x00000200",
            },
        ],
        [
            "data_fld_4",
            ...
            None,
            {
                "field_value_class": BytesFieldData,
                "size_not_updated": True,
                "condition": "f.existence_mask & 0x00000100",
            },
        ],
        [
            "data_fld_5",
            ...
            None,
            {
                "field_value_class": BytesFieldData,
                "size_not_updated": True,
                "condition": "f.existence_mask & 0x00000080",
            },
        ],
        [
            "data_fld_6",
            ...
            None,
            {
                "field_value_class": BytesFieldData,
                "size_not_updated": True,
                "condition": "f.existence_mask & 0x00000040",
            },
        ],
    ],
    [
        "num_aux_b",
        "Number of Auxiliary Band Level Parameters (m)",
        2,
        int,
    ...
    [
        ["loop", "f.num_aux_b if(f.existence_mask & 0x00000001) else 0"],
        [
            "bapf",
            "Band Auxiliary Parameter Value Format",
            1,
            str,
            {"condition": "f.existence_mask & 0x00000001"},
        ],
        [
            "ubap",
            "Unit of Band Auxiliary Parameter",
            7,
            str,
            {"condition": "f.existence_mask & 0x00000001"},
        ],
        [
            ["loop", "f.count if(f.existence_mask & 0x00000001) else 0"],
            [
                "apn_band",
                "Auxiliary Parameter Integer Value",
                10,
                int,
                {"condition": 'f.bapf[i1] == "I"'},
            ],
            [
                "apr_band",
                "Auxiliary Parameter Real Value",
                4,
                None,
                {
                    "field_value_class": FloatFieldData,
                    "size_not_updated": True,
                    "condition": 'f.bapf[i1] == "R"',
                },
            ],
            [
                "apa_band",
                "Auxiliary Parameter ASCII Value",
                20,
                int,
                {"condition": 'f.bapf[i1] == "A"'},
            ],
        ],
    ],
    [
