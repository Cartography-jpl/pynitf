...
desc = [
    ...
    [
        "origin_x",
        "Column Position of the Upper Left Pixel Metric Value",
        14,
        float,
        {"frmt": _origin_format},
    ],
    [
        "origin_y",
        "Row Position of the Upper Left Pixel Metric Value",
        14,
        float,
        {"frmt": _origin_format},
    ],
    ...
    [
        "nummetrics",
        "Number of Metrics Specified in the Pixel Metric Image Segment",
        5,
        int,
    ],
    ...
    [
        ...
        [
            "fittype",
            "Mathematical Form of the Data Transformation for the mth Pixel Metric",
            1,
            str,
        ],
        [
            "numcoef",
            "Number of Coefficients Used by the Data Transformation of the mth Pixel Metric",
            1,
            int,
        ...
        [
            ...
            [
                "coef",
                "jth Data Transformation Coefficient for the mth Pixel Metric",
                15,
                float,
                {"frmt": _coef_format},
            ],
...
class TrePIXMTA(Tre):
    ...
    def summary(self):
        res = io.StringIO()
        print(
            "TRE - PIXMTA %s Associated ISs, %d Metrics"
            % (self.numais, self.nummetrics),
            file=res,
        )
        return res.getvalue()
