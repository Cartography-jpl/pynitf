...
DesEXT_DEF_CONTENT = create_nitf_des_structure("DesEXT_DEF_CONTENT", desc2, hlp=hlp)
...
def _summary(self):
    res = six.StringIO()
    print("EXT_DEF_CONTENT headers:  %s" % self.content_headers, file=res)
    return res.getvalue()

DesEXT_DEF_CONTENT.summary = _summary

__all__ = ["DesEXT_DEF_CONTENT"]
