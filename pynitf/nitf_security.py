class NitfSecurity(object):
    ...
    def set_security(self, elem, prefix):
        ...
        for field_name, attribute_name in [
            ...
            if hasattr(elem, prefix + field_name):
                setattr(elem, prefix + field_name, getattr(self, attribute_name))
        if hasattr(elem, "encryp"):
...
"""
    ...
    def __eq__(self, other):
        return (
            ...
            and self.classification_system == other.classification_system
            and self.control_and_handling == other.control_and_handling
            and self.release_instructions == other.release_instructions
            and self.declassification_type == other.declassification_type
            and self.declassification_date == other.declassification_date
            and self.declassification_exemption == other.declassification_exemption
            and self.downgrade == other.downgrade
            and self.downgrade_date == other.downgrade_date
            and self.classification_text == other.classification_text
            and self.classification_authority_type
            == other.classification_authority_type
            and self.classification_authority == other.classification_authority
            and self.classification_reason == other.classification_reason
            and self.security_source_date == other.security_source_date
            and self.security_control_number == other.security_control_number
            and self.copy_number == other.copy_number
            and self.number_of_copies == other.number_of_copies
