       ...
       [["loop", "f.num_spdcf"],
        ...
        [["loop", "f.spdcf_p[i1]"],
         ...
         ["spdcf_weight", "Weighting of the jth constituent SPDCF",
          5, float, {"frmt" : "%05.3lf"}],
         ["fp_a", "CSM Four Parameter Correlation Function Parameter A",
          8, float,
         ...
         [["loop", "f.num_segs[i1,i2]"],
          ...
          ["pl_tau_max_cor", "Piece-Wise Linear Function Difference (Tau Segment Value)", 21, float, {"frmt" : "%15.14le"}],
          ],
