...
desc = ["SENSRB",
        ...
        ["icx_north_or_x", "Image Coord X Unit Vector 1", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
        ["icx_east_or_y", "Image Coord X Unit Vector 2", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
        ["icx_down_or_z", "Image Coord X Unit Vector 3", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
        ["icy_north_or_x", "Image Coord Y Unit Vector 1", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
        ["icy_east_or_y", "Image Coord Y Unit Vector 2", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
        ["icy_down_or_z", "Image Coord Y Unit Vector 3", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
        ["icz_north_or_x", "Image Coord Z Unit Vector 1", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
        ["icz_east_or_y", "Image Coord Z Unit Vector 2", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
        ["icz_down_or_z", "Image Coord Z Unit Vector 3", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.8'}],
