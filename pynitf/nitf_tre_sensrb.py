...
desc = ["SENSRB",
        ...
        ["platform_uri", "Platform URI", 32, str, {'condition' : "f.general_data == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ...
        ["generation_count", "Generation Count", 2, int, {"frmt" : "%02d", 'condition' : "f.general_data == 'Y'"}],
        ["generation_date", "Generation Date", 8, int, {'condition' : "f.general_data == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["generation_time", "Generation Time", 10, float, {'condition' : "f.general_data == 'Y'", "frmt" : "%010.3f", 'optional': True, 'optional_char' : '-', 'default' : None}],
        #2. Sensor Array Data
        ...
        ["row_metric", "Row Metric", 8, float, {'condition' : "f.sensor_array_data == 'Y'", "frmt" : "%08lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["column_metric", "Column Metric", 8, float, {'condition' : "f.sensor_array_data == 'Y'", "frmt" : "%08lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["focal_length", "Focal Length", 8, float, {'condition' : "f.sensor_array_data == 'Y'", "frmt" : "%08lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["row_fov", "Row Field of View", 8, float, {'condition' : "f.sensor_array_data == 'Y'", "frmt" : "%08.3lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["column_fov", "Column Field of View", 8, float, {'condition' : "f.sensor_array_data == 'Y'", "frmt" : "%08.3lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ...
        ["principal_point_offset_x", "Principal Point Offset X", 9, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%09.5lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["principal_point_offset_y", "Principal Point Offset Y", 9, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%09.5lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["radial_distort_1", "Radial Distortion Coeff 1", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["radial_distort_2", "Radial Distortion Coeff 2", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["radial_distort_3", "Radial Distortion Coeff 3", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["radial_distort_limit", "Radial Distortion Fit Limit", 9, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%09.2lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["decent_distort_1", "Decentering Distortion Coeff 1", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["decent_distort_2", "Decentering Distortion Coeff 2", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["affinity_distort_1", "Affinity Distortion Coeff 1", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["affinity_distort_2", "Affinity Distortion Coeff 2", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["calibration_date", "Calibration Date", 8, str, {'condition' : "f.sensor_calibration_data == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ...
        ["row_count", "Row Count", 8, int, {'condition' : "f.image_formation_data == 'Y'", "frmt" : "%08d"}],
        ["column_count", "Column Count", 8, int, {'condition' : "f.image_formation_data == 'Y'", "frmt" : "%08d"}],
        ["row_set", "Row Detection Set", 8, int, {'condition' : "f.image_formation_data == 'Y'", "frmt" : "%08d"}],
        ["column_set", "Column Detection Set", 8, int, {'condition' : "f.image_formation_data == 'Y'", "frmt" : "%08d"}],
        ["row_rate", "Row Detection Rate", 10, float, {'frmt' : '%010.8f', 'condition' : "f.image_formation_data == 'Y'"}],
        ["column_rate", "Column Detection Rate", 10, float, {'frmt' : '%010.8f','condition' : "f.image_formation_data == 'Y'"}],
        ["first_pixel_row", "First Collected Pixel Row", 8, int, {'condition' : "f.image_formation_data == 'Y'", "frmt" : "%08d"}],
        ["first_pixel_column", "First Collected Pixel Column", 8, int, {'condition' : "f.image_formation_data == 'Y'", "frmt" : "%08d"}],
        ...
        ["reference_time", "Reference Time", 12, float, {"frmt" : "%012.6lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["reference_row", "Reference Pixel Row", 8, float, {"frmt" : "%08.3lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["reference_column", "Reference Pixel Column", 8, float, {"frmt" : "%08.3lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ...
        ["sensor_angle_1", "Sensor Angle 1", 10, float, {"frmt" : "%010.5lf",
                              'condition' : "f.attitude_euler_angles == 'Y'"}],
        ["sensor_angle_2", "Sensor Angle 2", 9, float, {"frmt" : "%09.5lf", 'condition' : "f.attitude_euler_angles == 'Y'"}],
        ["sensor_angle_3", "Sensor Angle 3", 10, float, {"frmt" : "%010.5lf", 'condition' : "f.attitude_euler_angles == 'Y'"}],
        ["platform_relative", "Platform Relative Angles", 1, str, {'condition' : "f.attitude_euler_angles == 'Y'"}],
        ["platform_heading", "Platform Heading", 9, float, {"frmt": "%09.5lf", 'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["platform_pitch", "Platform Pitch", 9, float, {"frmt" : "%09.5lf",'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["platform_roll", "Platform Roll", 10, float, {"frmt" : "%010.5lf", 'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        #8. Attitude Unit Vectors
        ["attitude_unit_vectors", "Attitude Unit Vectors", 1, str, {"default" : "N"}],
        ["icx_north_or_x", "Image Coord X Unit Vector 1", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ["icx_east_or_y", "Image Coord X Unit Vector 2", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ["icx_down_or_z", "Image Coord X Unit Vector 3", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ["icy_north_or_x", "Image Coord Y Unit Vector 1", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ["icy_east_or_y", "Image Coord Y Unit Vector 2", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ["icy_down_or_z", "Image Coord Y Unit Vector 3", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ["icz_north_or_x", "Image Coord Z Unit Vector 1", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ["icz_east_or_y", "Image Coord Z Unit Vector 2", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ["icz_down_or_z", "Image Coord Z Unit Vector 3", 10, float, {'condition' : "f.attitude_unit_vectors == 'Y'", 'frmt': '%010.7lf'}],
        ...
        [["loop", "f.point_set_data"],
         ...
         [["loop", "f.point_count[i1]"],
          ...
          ["p_latitude", "Point Latitude", 10, float, {'frmt' : '%010.6lf', 'optional': True, 'optional_char' : '-', 'default' : None}],
          ["p_longitude", "Point Longitude", 11, float, {'frmt' : '%011.6lf', 'optional': True, 'optional_char' : '-', 'default' : None}],
          ["p_elevation", "Point Elevation", 6, float, {'frmt' : '%06.1lf', 'optional': True, 'optional_char' : '-', 'default' : None}],
          ["p_range", "Point Range", 8, float, {'frmt' : '%08.1lf', 'optional': True, 'optional_char' : '-', 'default' : None}],
         ],
        ],
        ...
        [["loop", "f.uncertainty_data"],
         ...
         ["uncertainty_second_type", "Uncertainty Second Index", 11, str, {'optional': True, 'optional_char' : '-', 'default' : None}],
