...
desc = ["SENSRB",
        ...
        ["principal_point_offset_x", "Principal Point Offset X", 9, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%09lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["principal_point_offset_y", "Principal Point Offset Y", 9, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%09lf", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ...
        ["sensor_angle_1", "Sensor Angle 1", 10, float, {"frmt" : "%03.5lf",
                              'condition' : "f.attitude_euler_angles == 'Y'"}],
        ["sensor_angle_2", "Sensor Angle 2", 9, float, {"frmt" : "%02.5lf", 'condition' : "f.attitude_euler_angles == 'Y'"}],
        ["sensor_angle_3", "Sensor Angle 3", 10, float, {"frmt" : "%03.5lf", 'condition' : "f.attitude_euler_angles == 'Y'"}],
        ["platform_relative", "Platform Relative Angles", 1, str, {'condition' : "f.attitude_euler_angles == 'Y'"}],
        ["platform_heading", "Platform Heading", 9, float, {"frmt": "%03.5lf", 'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["platform_pitch", "Platform Pitch", 9, float, {"frmt" : "%02.5lf",'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["platform_roll", "Platform Roll", 10, float, {"frmt" : "%03.5lf", 'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
