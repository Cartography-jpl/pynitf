...
desc = ["SENSRB",
        ...
        ["row_metric", "Row Metric", 8, float, {'condition' : "f.sensor_array_data == 'Y'", "frmt" : "%08lf"}],
        ["column_metric", "Column Metric", 8, float, {'condition' : "f.sensor_array_data == 'Y'", "frmt" : "%08lf"}],
        ["focal_length", "Focal Length", 8, float, {'condition' : "f.sensor_array_data == 'Y'", "frmt" : "%08lf"}],
        ...
        ["radial_distort_1", "Radial Distortion Coeff 1", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le"}],
        ["radial_distort_2", "Radial Distortion Coeff 2", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le"}],
        ["radial_distort_3", "Radial Distortion Coeff 3", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le"}],
        ["radial_distort_limit", "Radial Distortion Fit Limit", 9, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%09lf"}],
        ["decent_distort_1", "Decentering Distortion Coeff 1", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le"}],
        ["decent_distort_2", "Decentering Distortion Coeff 2", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le"}],
        ["affinity_distort_1", "Affinity Distortion Coeff 1", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le"}],
        ["affinity_distort_2", "Affinity Distortion Coeff 2", 12, float, {'condition' : "f.sensor_calibration_data == 'Y'", "frmt" : "%08le"}],
        ["calibration_date", "Calibration Date", 8, str, {'condition' : "f.sensor_calibration_data == 'Y'"}],
