...
desc = ["SENSRB",
        ...
        ["platform_heading", "Platform Heading", 9, int, {'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["platform_pitch", "Platform Pitch", 9, int, {'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
        ["platform_roll", "Platform Roll", 10, int, {'condition' : "f.attitude_euler_angles == 'Y'", 'optional': True, 'optional_char' : '-', 'default' : None}],
