...
desc = [
    ...
    [
        "cvdate",
        "Version Date of the Original Image Error Covariance.",
        8,
        str,
        {"condition": "f.inclic == 'Y'"},
    ],
    ...
    ["aptyp", "Adjustable Parameter Type", 1, str, {"condition": "f.inclic == 'Y'"}],
    [
        "loctyp",
    ...
    [
        "nsfx",
        "Normalization Scale Factor for X",
        21,
        float,
    ...
    [
        "nsfy",
        "Normalization Scale Factor for Y",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y'"},
    ],
    [
        "nsfz",
        "Normalization Scale Factor for Z",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y'"},
    ],
    ...
    [
        "xuol",
        "Local Coordinate Origin (XUOL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "yuol",
        "Local Coordinate Origin (YUOL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    ...
    [
        "xuxl",
        "Local Coordinate Unit Vector (XUXL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "xuyl",
        "Local Coordinate Unit Vector (XUYL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "xuzl",
        "Local Coordinate Unit Vector (XUZL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "yuxl",
        "Local Coordinate Unit Vector (YUXL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "yuyl",
        "Local Coordinate Unit Vector (YUYL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "yuzl",
        "Local Coordinate Unit Vector (YUZL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "zuxl",
        "Local Coordinate Unit Vector (ZUXL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "zuyl",
        "Local Coordinate Unit Vector (ZUYL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    [
        "zuzl",
        "Local Coordinate Unit Vector (ZUZL).",
        21,
        float,
        {"frmt": _xuol_format, "condition": "f.inclic == 'Y' and f.loctyp == 'R'"},
    ],
    ...
    [
        ...
        [
            ["loop", "f.nbasis"],
            ["ael", "Matrix A Element, Row order", 21, float, {"frmt": _xuol_format}],
        ],
    ],
    [
        ["loop", "f.ign"],
        ["numopg", "Number of Original Adjustable Parameters in Subgroup. ", 2, int],
        [
            ["loop", "(f.numopg[i1]+1)*f.numopg[i1] // 2"],
            [
                "errcvg",
                "Original Error Covariance Element",
                21,
                float,
                {"frmt": _xuol_format},
            ],
        ...
        [
            ["loop", "f.ncseg[i1]"],
            ["corseg", "Segment Correlation Value", 21, float, {"frmt": _xuol_format}],
            ["tauseg", "Segment Tau Value", 21, float, {"frmt": _xuol_format}],
        ],
        [
            "ac",
            "CSM correlation function A parameter",
            21,
            float,
            {
                "frmt": _xuol_format,
        ...
        [
            "alpc",
            "CSM correlation function alpha parameter",
            21,
            float,
            {
                "frmt": _xuol_format,
        ...
        [
            "betc",
            "CSM correlation function beta parameter",
            21,
            float,
            {
                "frmt": _xuol_format,
        ...
        [
            "tc",
            "CSM correlation function T parameter",
            21,
            float,
            {
                "frmt": _xuol_format,
    ...
    [
        ...
        [
            ["loop", "f.nparo"],
            ["map", "Mapping Matrix Element.", 21, float, {"frmt": _xuol_format}],
        ],
    ],
    [
        "urr",
        "Unmodeled Row Variance.",
        21,
        float,
    ...
    [
        ["loop", "f.uncsr"],
        ["ucorsr", "Segment Correlation Value", 21, float, {"frmt": _xuol_format}],
    ...
    [
        ["loop", "f.uncsc"],
        ["ucorsc", "Segment Correlation Value", 21, float, {"frmt": _xuol_format}],
