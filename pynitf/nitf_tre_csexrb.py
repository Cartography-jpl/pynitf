...
desc = [
    ...
    [
        "ground_ref_point_x",
        "X coordinate of Ground reference point",
        12,
        float,
        {"frmt": _pt_format, "optional": True},
    ],
    [
        "ground_ref_point_y",
        "Y coordinate of Ground reference point",
        12,
        float,
        {"frmt": _pt_format, "optional": True},
    ],
    [
        "ground_ref_point_z",
        "Z coordinate of Ground reference point",
        12,
        float,
        {"frmt": _pt_format, "optional": True},
    ],
    [
        ...
        "Day of First Line of Synthetic Array Image",
        8,
        str,
        {"condition": f"f.sensor_type in {push_instrument}"},
    ],
    [
        "time_first_line_image",
        "Time of First Line of Synthetic Array Image",
        15,
        float,
        {"condition": f"f.sensor_type in {push_instrument}", "frmt": "%015.9lf"},
    ],
    [
        "time_image_duration",
        "Time of Image Duration",
        16,
        float,
        {"condition": f"f.sensor_type in {push_instrument}", "frmt": _tm_format},
    ],
    [
        "time_stamp_loc",
    ...
    [
        "max_gsd",
        "Maximum Mean Ground Sample Distance (GSD)",
        12,
        float,
        {"frmt": _gsd_12_format, "optional": True},
    ],
    [
        "along_scan_gsd",
        "Measured Along-Scan Ground Sample Distance (GSD)",
        12,
        float,
        {"frmt": _gsd_12_format, "optional": True},
    ],
    [
        "cross_scan_gsd",
        "Measured Cross-Scan Ground Sample Distance (GSD)",
        12,
        float,
        {"frmt": _gsd_12_format, "optional": True},
    ],
    [
        "geo_scan_gsd",
        "Measured Geometric Mean Ground Sample Distance (GSD)",
        12,
        float,
        {"frmt": _gsd_12_format, "optional": True},
    ],
    [
        "a_s_vert_gsd",
        "Measured Along-Scan Vertical Ground Sample Distance (GSD)",
        12,
        float,
        {"frmt": _gsd_12_format, "optional": True},
    ],
    [
        "c_s_vert_gsd",
        "Measured Cross-Scan Vertical Ground Sample Distance (GSD)",
        12,
        float,
        {"frmt": _gsd_12_format, "optional": True},
    ],
    [
        "geo_mean_vert_gsd",
        "Measured Geometric Mean Vertical Ground Sample Distance (GSD)",
        12,
        float,
        {"frmt": _gsd_12_format, "optional": True},
    ],
    [
        ...
        5,
        float,
        {"frmt": _gsd_5_format, "optional": True},
    ],
    [
        "dynamic_range",
    ...
    ["num_lines", "Number of Lines in the Entire Image Plane", 7, int],
    ["num_samples", "Number of Samples in the Entire Image Plane", 5, int],
    [
        "angle_to_north",
    ...
    ["atm_refr_flag", "Atmospheric Refraction Flag", 1, int, {"default": 1}],
    ...
    [
        "predicted_niirs",
        "NIIRS Value for the Mono Collection of Principal Target",
        3,
        float,
        {"frmt": "%02.1lf", "optional": True},
    ],
    ["circl_err", "Circular Error", 5, float, {"frmt": "%05.1lf", "optional": True}],
    ["linear_err", "Linear Error", 5, float, {"frmt": "%05.1lf", "optional": True}],
    ["cloud_cover", "Cloud Cover", 3, int, {"optional": True}],
    [
        "rolling_shutter_flag",
        "Rolling Shutter Flag",
        1,
        int,
        {"condition": 'f.sensor_type=="F"', "optional": True},
    ],
    ["ue_time_flag", "Time Un-Modeled Error Flag", 1, int, {"optional": True}],
