...
def test_tre_sensrb_sensor_calibration_data():
    ...
    t.write_to_file(fh)
    #print(fh.getvalue())
    assert fh.getvalue() == b'SENSRB00227NNYmm01.000000-1.0000001.000000e+022.000000e+023.000000e+02000001.001.000000e+032.100000e+023.700000e+056.400000e+0220170505N00000.0000000000.0000000.00000000010.00000000020.0000100000.000000.0000000.0000000.000NNNN000000000000'
    fh2 = six.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
