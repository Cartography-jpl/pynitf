...
def test_tre_sensrb_empty():
    ...
    assert (
        fh.getvalue()
        == b"SENSRB00106NNNN00000.0000000000.0000000.00000000010.00000000020.0000100000.000000.0000000.0000000.000NNNN000000000000"
    )
...
def test_tre_sensrb_general_data():
    ...
    assert (
        fh.getvalue()
        == b"SENSRB00309YMy sensor                blah                            My platform              blah                            blah      1WGS84GHAESID  2017042700000.999999992017042786399.999999990020170427235959.999NNN00000.0000000000.0000000.00000000010.00000000020.0000100000.000000.0000000.0000000.000NNNN000000000000"
    )
    fh2 = io.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
...
def test_tre_sensrb_additional_parameter():
    ...
    assert (
        fh.getvalue()
        == b"SENSRB00177NNNN00000.0000000000.0000000.00000000010.00000000020.0000100000.000000.0000000.0000000.000NNNN000000000002parm 1                   00100010parm 2                   0020003000102"
    )
    fh2 = io.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
...
def test_tre_sensrb_sensor_array():
    ...
    assert (
        fh.getvalue()
        == b"SENSRB00183NYsome detection      00001000000010001.1000001.1000001.2000000001.3000001.300YNN00000.0000000000.0000000.00000000010.00000000020.0000100000.000000.0000000.0000000.000NNNN000000000000"
    )
    fh2 = io.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
...
def test_tre_sensrb_sensor_calibration_data():
    ...
    assert (
        fh.getvalue()
        == b"SENSRB00227NNYmm001.00000-01.000001.000000e+022.000000e+023.000000e+02000001.001.000000e+032.100000e+023.700000e+056.400000e+0220170505N00000.0000000000.0000000.00000000010.00000000020.0000100000.000000.0000000.0000000.000NNNN000000000000"
    )
    fh2 = io.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
...
def test_tre_sensrb_attitude_quaternion():
    ...
    assert (
        fh.getvalue()
        == b"SENSRB00146NNNN00000.0000000000.0000000.00000000010.00000000020.0000100000.000000.0000000.0000000.000NNY00.000100000.000200000.000300000.0004000N000000000000"
    )
    fh2 = io.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
