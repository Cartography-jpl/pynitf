from pynitf import DesEXT_DEF_CONTENT, NitfFile, DesEXT_h5, NitfDesSegment
from fixtures.support_func import require_h5py
import os
import h5py
...
def test_h5py_file(isolated_dir):
    ...
    f2 = NitfFile("des_test.ntf")
    assert f2.des_segment[0].des.user_subheader.content_description == b"hi there"
    assert f2.des_segment[0].des.user_subheader.content_length == str(
