from pynitf import NitfFile, NitfLiteral, FieldData, TreUSE00A, Tre, tre_tag_to_cls
from fixtures.support_func import create_image_seg, create_tre
import copy
import pytest
...
def test_tre_modify_even_more_complicated_format(isolated_dir, modify_use00a_tre):
    ...
    my_desc[ind] = [
        ...
        float,
        {
            "field_value_class": ReverseNumber,
            "optional": True,
