...
def test_tre_pixmta():
    ...
    assert (
        fh.getvalue()
        == b"PIXMTA0034410 005006007008009010011012013014+1.2340000E-03-6.0012340E+00+1.0000000E+00+1.0000000E+00F00003ANESR                                    W/(m m um sr)                           DCENTER WAVELENGTH                       um                                      DCENTER WAVENUMBER                       1/cm                                    D00000"
    )
...
def test_tre_pixmta_fittype_p():
    ...
    assert (
        fh.getvalue()
        == b"PIXMTA0039010 005006007008009010011012013014+1.2340000E-03-6.0012340E+00+1.0000000E+00+1.0000000E+00F00003ANESR                                    W/(m m um sr)                           DCENTER WAVELENGTH                       um                                      DCENTER WAVENUMBER                       1/cm                                    P3+1.23000000E-03-1.23000000E-03-7.00123000E+0000000"
    )
    fh2 = io.BytesIO(fh.getvalue())
    t2 = TrePIXMTA()
    t2.read_from_file(fh2)
