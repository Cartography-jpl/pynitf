...
def test_basic():
    ...
    assert (
        fh.getvalue()
        == b"HISTOA00509SYSTEM_TYPE         NO_COMPRESSINONE0000220170615121212ABCDEFGHIJAAAAAAAAAA2HELLO1                                                                          HELLO2                                                                          00              0 00000000             20170615121212ABCDEFGHIJAAAAAAAAAA2HELLO1                                                                          HELLO2                                                                          00              0 00000000             "
    )
