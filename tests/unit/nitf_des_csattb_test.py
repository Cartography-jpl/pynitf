from pynitf import NitfDesSegment, NitfFile, DesCSATTB
import io
...
def test_des_snip_user_header():
    ...
    assert (
        fh_ds.getvalue()
        == b"4385ab47-f3ba-40b7-9520-13d6b7a7f3110100050060070080090100110120130140000000"
    )
...
def test_des_csattb_uuid_func(isolated_dir):
    ...
    assert f2.des_segment[0].des.assoc_elem(f2) == [
        f2.des_segment[1].des,
        f2.des_segment[2].des,
    ]
